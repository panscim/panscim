          ...
          <div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
            ...
            <div className="relative">
              <div className="text-center">
                ...
                {/* Upload Button - Now below the circle */}
                <button
                  onClick={() => fileInputRef.current?.click()}
                  disabled={isUploadingAvatar}
                  className="w-10 h-10 bg-brand-accent hover:bg-opacity-90 rounded-full flex items-center justify-center text-white transition-colors disabled:opacity-50 mx-auto mb-4"
                >
                  {isUploadingAvatar ? (
